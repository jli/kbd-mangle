...
var kbd_mangle = {main:{}};
kbd_mangle.main.txt_id = "txt";
kbd_mangle.main.ignore_chars = cljs.core.set([" "]);
kbd_mangle.main.get_elt = goog.dom.getElement;
kbd_mangle.main.html = goog.dom.htmlToDocumentFragment;
kbd_mangle.main.js_alert = function(a) {
  return alert(a)
};
kbd_mangle.main.dbug = function() {
  var a = null;
  return a = function(b, c) {
    switch(arguments.length) {
      case 1:
        return a.call(null, b, "dbug");
      case 2:
        return goog.dom.append.call(null, kbd_mangle.main.get_elt.call(null, c), b), goog.dom.append.call(null, kbd_mangle.main.get_elt.call(null, c), kbd_mangle.main.html.call(null, "<br>"))
    }
    throw"Invalid arity: " + arguments.length;
  }
}();
kbd_mangle.main.special_lowercase = cljs.core.HashMap.fromArrays(["@", "!", '"', "#", "$", "%", "&", "(", ")", "*", "+", ":", "{", "<", "|", "}", ">", "^", "~", "?", "_"], ["2", "1", "'", "3", "4", "5", "7", "9", "0", "8", "=", ";", "[", ",", "\\", "]", ".", "6", "`", "/", "-"]);
kbd_mangle.main.deshift = function(a) {
  return cljs.core.get.call(null, kbd_mangle.main.special_lowercase, a, a).toLowerCase()
};
kbd_mangle.main.clean_text = function(a) {
  return cljs.core.map.call(null, kbd_mangle.main.deshift, a)
};
kbd_mangle.main.qwerty_key__GT_coord = cljs.core.HashMap.fromArrays([" ", "`", "a", "b", "c", "d", "e", "f", "'", "g", "h", "i", "j", "k", ",", "l", "-", "m", ".", "n", "/", "o", "0", "p", "1", "q", "2", "r", "3", "s", "4", "t", "5", "u", "6", "v", "7", "w", "8", "x", "9", "y", "z", ";", "[", "\\", "=", "]"], [cljs.core.Vector.fromArray([375, 335]), cljs.core.Vector.fromArray([35, 120]), cljs.core.Vector.fromArray([130, 225]), cljs.core.Vector.fromArray([374, 275]), cljs.core.Vector.fromArray([266, 
275]), cljs.core.Vector.fromArray([238, 225]), cljs.core.Vector.fromArray([224, 174]), cljs.core.Vector.fromArray([292, 225]), cljs.core.Vector.fromArray([670, 225]), cljs.core.Vector.fromArray([346, 225]), cljs.core.Vector.fromArray([400, 225]), cljs.core.Vector.fromArray([494, 174]), cljs.core.Vector.fromArray([454, 225]), cljs.core.Vector.fromArray([508, 225]), cljs.core.Vector.fromArray([536, 275]), cljs.core.Vector.fromArray([562, 225]), cljs.core.Vector.fromArray([630, 120]), cljs.core.Vector.fromArray([482, 
275]), cljs.core.Vector.fromArray([590, 275]), cljs.core.Vector.fromArray([428, 275]), cljs.core.Vector.fromArray([644, 275]), cljs.core.Vector.fromArray([548, 174]), cljs.core.Vector.fromArray([579, 120]), cljs.core.Vector.fromArray([602, 174]), cljs.core.Vector.fromArray([90, 120]), cljs.core.Vector.fromArray([115, 174]), cljs.core.Vector.fromArray([144, 120]), cljs.core.Vector.fromArray([278, 174]), cljs.core.Vector.fromArray([198, 120]), cljs.core.Vector.fromArray([184, 225]), cljs.core.Vector.fromArray([253, 
120]), cljs.core.Vector.fromArray([332, 174]), cljs.core.Vector.fromArray([307, 120]), cljs.core.Vector.fromArray([440, 174]), cljs.core.Vector.fromArray([361, 120]), cljs.core.Vector.fromArray([320, 275]), cljs.core.Vector.fromArray([415, 120]), cljs.core.Vector.fromArray([169, 174]), cljs.core.Vector.fromArray([469, 120]), cljs.core.Vector.fromArray([212, 275]), cljs.core.Vector.fromArray([524, 120]), cljs.core.Vector.fromArray([386, 174]), cljs.core.Vector.fromArray([158, 275]), cljs.core.Vector.fromArray([616, 
225]), cljs.core.Vector.fromArray([656, 174]), cljs.core.Vector.fromArray([764, 174]), cljs.core.Vector.fromArray([685, 120]), cljs.core.Vector.fromArray([710, 174])]);
kbd_mangle.main.initialize_heat = function(a, b) {
  var c = cljs.core.frequencies.call(null, kbd_mangle.main.clean_text.call(null, b)), d = cljs.core.map.call(null, function(a) {
    var b = cljs.core.nth.call(null, a, 0, null), a = cljs.core.nth.call(null, a, 1, null), c = kbd_mangle.main.qwerty_key__GT_coord.call(null, b);
    return cljs.core.truth_(c) ? (b = cljs.core.nth.call(null, c, 0, null), c = cljs.core.nth.call(null, c, 1, null), cljs.core.ObjMap.fromObject(["x", "y", "count"], {x:b, y:c, count:a})) : kbd_mangle.main.dbug.call(null, cljs.core.str.call(null, "weird, unhandled char: ", b, a))
  }, c), c = cljs.core.ObjMap.fromObject(["max", "data"], {max:cljs.core.reduce.call(null, cljs.core.max, 0, cljs.core.vals.call(null, c)), data:cljs.core.apply.call(null, cljs.core.array, cljs.core.map.call(null, function(a) {
    return a.strobj
  }, d))}).strobj;
  return a.store.setDataSet(c)
};
kbd_mangle.main.thundercats_are_go = function() {
  var a = cljs.core.ObjMap.fromObject(["visible", "opacity"], {visible:!0, opacity:40}), a = cljs.core.assoc.call(null, a, "element", "kbd-qwerty"), b = window.h337.create.call(null, a.strobj);
  kbd_mangle.main.initialize_heat.call(null, b, kbd_mangle.main.get_elt.call(null, kbd_mangle.main.txt_id).value);
  return goog.events.listen.call(null, kbd_mangle.main.get_elt.call(null, kbd_mangle.main.txt_id), goog.events.EventType.KEYUP, function() {
    return kbd_mangle.main.initialize_heat.call(null, b, kbd_mangle.main.get_elt.call(null, kbd_mangle.main.txt_id).value)
  })
};
goog.exportSymbol("kbd_mangle.main.thundercats_are_go", kbd_mangle.main.thundercats_are_go);
